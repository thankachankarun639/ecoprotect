...
<h1 style="position : absolute;
 ...
 font-size : 25px;
 border-bottom : 2px solid black;">PUBLICIZERS</h1>
...
<div id="Info">
<?php
$sql = mysql_query("SELECT * FROM publicity");
...
echo"</table>";
   echo "<table cellspacing=\"20\">";
   echo "<br/><br/><br/><br/><br/>";
   $sql = mysql_query("SELECT Event,Count(*) AS Count FROM publicity GROUP BY Event"); 
   while($row=mysql_fetch_array($sql))
   {
	 $ename = $row["Event"];
	 $count = $row["Count"];
...
<?php
 include("../db/delete_publicity.php");
?>