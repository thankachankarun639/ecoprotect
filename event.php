...
<p>The files uploaded should be in <b>zip</b> or <b>tar.gz</b> format. They should not exceed 5MB in the size and the compressed file nust consist of a poster for the event, guidlelnes for the events, aim/vision/mission of the event and in what light the publicity should go for the event (donations reqired or not). Only after careful consideration will the event be assigned in the site.
</p>
</div>

<div id="continue">
<a href="login.php">LOGIN</a> AND GET INVOLVED
</div>
